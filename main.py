...
def gameWindows(boardSize, bombSize):
    ...
    tk.Label(sideMenu, text=f"Press [Right Mouse] \nto flag a spot \n \n \n Size: {boardSize}x{boardSize} \n \n Bombs: {bombSize}", bg = "grey27" ,fg="WHITE", font=("Courier", 15)).place(relx = 0.5, anchor=tk.CENTER, y = 150)
    tk.Button(sideMenu, text="Restart", command=restart).place(relx=0.5, anchor=tk.CENTER, y=290)
    tk.Button(sideMenu,text = "Menu", command = menu).place(relx = 0.5, anchor=tk.CENTER, y = 330)
    tk.Button(sideMenu,text = "Exit", command = window.destroy).place(relx = 0.5, anchor=tk.CENTER, y = 370)
...
def userInput():
    ...
    l.place(relx=0.5, anchor=tk.CENTER, y=110)

    cLabel = tk.Label(user, text="Size: _ x _", bg="grey20", fg="WHITE", font=("Courier", 14))
    cLabel.place(relx=0.5, anchor=tk.CENTER, y=140)
    textInput = tk.Entry(bg="grey80", fg="BLACK", width = 3, font = ("Courier", 15))
    textInput.place(relx=0.5, anchor=tk.CENTER, y=170)
    ...
    l.place(relx=0.5, anchor=tk.CENTER, y=230)
    bLabel = tk.Label(user, text="Size: _", bg="grey20", fg="WHITE", font=("Courier", 14))
    bLabel.place(relx=0.5, anchor=tk.CENTER, y=250)
    textMines = tk.Entry(user, bg="grey80", fg="BLACK", width = 3, font = ("Courier", 15))
    textMines.place(relx = 0.5, anchor=tk.CENTER, y = 280)
    ...
    buttonPlay = tk.Button(user, bg = "grey40", fg = "WHITE", text="Play!", command = playGame)
    buttonPlay.place(relx = 0.5, anchor=tk.CENTER, y = 320)
    user.mainloop()
#gameWindows(30,150)
userInput()
